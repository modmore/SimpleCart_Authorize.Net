 ...
 *
 * @package simplecart_authorizenet
...
$corePath = $modx->getOption('simplecart_authorizenet.core_path', null, $modx->getOption('core_path') . 'components/simplecart_authorizenet/');
...
/* handle request */
$path = $corePath . 'processors/' . (($validWebAction) ? 'web/' : '');
