...
class simplecart_authorizenet
{
    ...
    public function __construct(modX &$modx, array $config=array()) {
        ...
        $basePath = $this->modx->getOption('simplecart_authorizenet.core_path', $config, $this->modx->getOption('core_path').'components/simplecart_authorizenet/');
		$assetsPath = $this->modx->getOption('simplecart_authorizenet.assets_path', $config, $this->modx->getOption('assets_path').'components/simplecart_authorizenet/');
        $assetsUrl = $this->modx->getOption('simplecart_authorizenet.assets_url', $config, $this->modx->getOption('assets_url').'components/simplecart_authorizenet/');
