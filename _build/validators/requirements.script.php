...
switch($options[xPDOTransport::PACKAGE_ACTION]) {
    ...
    case xPDOTransport::ACTION_UPGRADE:
        ...
        if (version_compare($modxVersion['full_version'], '2.6.0') < 0) {
        ...
        if ($success) {
            ...
            $modx->log(xPDO::LOG_LEVEL_ERROR, 'Unfortunately, your server does not meet the minimum requirements for the Authorize.net gateway for SimpleCart and installation cannot continue.');
        }
